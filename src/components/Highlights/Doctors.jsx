	...
	return (
		<div className="overflow-x-hidden font-sans bg-gradient-to-b from-blue-50 to-white">
			...
			<header
				...
				style={{
					backgroundImage: `url('/src/assets/doctors_header2.jpg')`,
				}}
			>
				<Navbar />
				...
				<div className="relative container mx-auto h-full flex flex-col justify-center items-center text-center text-white px-4">
					...
					<p className="text-lg md:text-xl mt-4">
						Dedicated to providing compassionate and quality
						healthcare.
					</p>
				</div>
			</header>
			...
			<section className="container mx-auto py-12 px-4">
				...
				<p className="text-lg text-gray-700 text-center mb-12">
					Meet the highly skilled and compassionate professionals
					behind our exceptional healthcare services.
				</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
					{doctors.map((doctor, index) => (
						...
						>
							...
							<div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6 flex flex-col justify-start text-center">
